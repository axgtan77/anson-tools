...
const EV_MODELS = {
    ...
    'geely-emgrand-ev': {
        ...
        battery: 53.0,
        range: 400,
        consumption: { eco: 19.0, normal: 23.5, sport: 28.5 },
        motor: '100 kW / 134 hp',
    ...
    'zeekr-x': {
        ...
        battery: 66.0,
        range: 440,
        consumption: { eco: 20.5, normal: 25.5, sport: 30.5 },
        motor: '200 kW / 268 hp',
    ...
    'denza-d9-ev': {
        ...
        battery: 103.0,
        range: 570,
        consumption: { eco: 25.0, normal: 30.5, sport: 37.0 },
        motor: '230 kW / 308 hp',
    ...
    'xiaomi-su7': {
        ...
        battery: 73.6,
        range: 668,
        consumption: { eco: 16.5, normal: 20.5, sport: 25.0 },
        motor: '220 kW / 295 hp',
    ...
    'xiaomi-su7-max': {
        ...
        battery: 101.0,
        range: 800,
        consumption: { eco: 18.5, normal: 23.0, sport: 28.0 },
